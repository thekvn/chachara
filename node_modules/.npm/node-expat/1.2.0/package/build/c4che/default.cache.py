...
CPPPATH_NODE = '/Users/cachafla/local/node/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/cachafla/.node_libraries'
LIBPATH_NODE = '/Users/cachafla/local/node/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/cachafla/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/cachafla/local/node'
